...
3. Output ONLY valid HTML inside a single raw code block without markdown tags.
Do not wrap it in \`\`\`html. Just return the raw HTML string starting with <!DOCTYPE html>.`;
